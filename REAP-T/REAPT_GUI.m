...
XConstraintsU = uitextarea(fig, 'Position', [130 170 250 22]);
% 
uilabel(fig, 'Text', 'X constraint L.B.:', 'Position',  [20 140 100 22]);
XConstraintsL = uitextarea(fig, 'Position',[130 140 250 22]);

uilabel(fig, 'Text', 'U constraint U.B:', 'Position',  [20 110 100 22]);
UConstraintsU = uitextarea(fig, 'Position', [130 110 250 22]);

uilabel(fig, 'Text', 'U constraint L.B.:', 'Position',   [20 80 100 22]);
UConstraintsL = uitextarea(fig, 'Position', [130 80 250 22]);
...
x0 = uitextarea(fig, 'Position',[530 330 250 22]);
...
Target = uitextarea(fig, 'Position', [530 220 250 22]);
