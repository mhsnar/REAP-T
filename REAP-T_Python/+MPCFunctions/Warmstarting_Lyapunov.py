...
def Warmstarting_Lyapunov(hatLambda = None,hat_u = None,NoS = None,NoI = None,Prediction_Horizion = None,M1 = None,M2 = None,x_pr = None,Omegastar = None,theta = None,K = None): 
...
#Warm Starting
    ...
    hat_lambda_omega_x1_0 = np.array([[hat_lambda_omega_x1_0],[hat_lambda_omega_x1(np.arange(NoS - NoS + 1,NoS+1))]])
    hat_lambda_omega_x2_0 = np.array([[hat_lambda_omega_x2_0],[hat_lambda_omega_x2(np.arange(NoS - NoS + 1,NoS+1))]])
    hat_lambda_omega_u1_0 = np.array([[hat_lambda_omega_u1_0],[hat_lambda_omega_u1(np.arange(NoI - NoI + 1,NoI+1))]])
    hat_lambda_omega_u2_0 = np.array([[hat_lambda_omega_u2_0],[hat_lambda_omega_u2(np.arange(NoI - NoI + 1,NoI+1))]])
